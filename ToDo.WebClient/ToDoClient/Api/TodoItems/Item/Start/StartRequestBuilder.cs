...
namespace ToDo.ToDoClient.Api.TodoItems.Item.Start
{
    ...
    public partial class StartRequestBuilder : BaseRequestBuilder
    {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/TodoItems/{id}/start", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ToDo.ToDoClient.Api.TodoItems.Item.Start.StartRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/TodoItems/{id}/start", rawUrl)
        {
        }
