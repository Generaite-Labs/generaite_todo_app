...
namespace ToDo.ToDoClient.Register
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ToDo.ToDoClient.Register.RegisterRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(global::ToDo.ToDoClient.Models.RegisterRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::ToDo.ToDoClient.Models.RegisterRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ToDo.ToDoClient.Models.RegisterRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ToDo.ToDoClient.Models.RegisterRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ToDo.ToDoClient.Register.RegisterRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ToDo.ToDoClient.Register.RegisterRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ToDo.ToDoClient.Register.RegisterRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
