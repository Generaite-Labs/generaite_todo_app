...
namespace ToDo.ToDoClient.ConfirmEmail
{
    ...
    public partial class ConfirmEmailRequestBuilder : BaseRequestBuilder
    {
        ...
        public ConfirmEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/confirmEmail{?changedEmail*,code*,userId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ToDo.ToDoClient.ConfirmEmail.ConfirmEmailRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ConfirmEmailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/confirmEmail{?changedEmail*,code*,userId*}", rawUrl)
        {
        }
